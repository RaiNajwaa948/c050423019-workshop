    ...
    <section id="Category" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[52px] mb-[100px]">
        <div class="flex flex-col gap-9">
            ...
            <a href="{{ route('front.details', $itemNewWorkshop->slug) }}" class="card">
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-3 bg-white">
                    ...
                    <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                        ...
                        @if ($itemNewWorkshop->is_open)
                            <div class="absolute top-2 right-2 bg-green-500 text-white px-3 py-1 rounded">
                                Open
                            </div>
                        @endif
                        @if ($itemNewWorkshop->has_started)
                            <div class="absolute top-2 left-2 bg-red-500 text-white px-3 py-1 rounded">
                                Started
                            </div>
                        @endif
                    </div>
            ...
            @empty
                <p class="text-center text-gray-500">No workshops available at the moment.</p>
            @endforelse
